...
// KiwifruitDev: I've replaced the engine messages with nothing.
// This is because these messages will cause a crash.

#define _EngineMsg(...)		   {};
#define _EngineDevMsg(...)     {};
#define _EngineWarning(...)    {};
#define _EngineDevWarning(...) {};
